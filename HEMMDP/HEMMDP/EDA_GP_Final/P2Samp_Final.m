function [pos,newbuffer]=P2Samp_Final(p1,p11,p2,p22,p3,p33,p4,p44,newbuffer,pos,BSPlusJ)
...
if (0<indx && indx<FSET_END+1)
    ...
    if broth==0
     [pos,newbuffer]=P2Samp_Final(p1,p11,p2,p22,p3,p33,p4,p44,newbuffer,pos,BSPlusJ);           %non complete tree: [pos,newbuffer]=P2bSamp_Final(p1,p11,p2,p22,p3,p33,p4,p44,newbuffer,pos,BSPlusJ);
    elseif uncle1==0
