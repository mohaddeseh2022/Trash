function pop = PopEDAGP_Final_Ver2(p0,p1,p11,p2,p22,p3,p33,p4,p44,popSize,trainD,BlockValue,BSPlusJ,Coeff,ADFFlag,newnum,thresh,k)
...
for j=1:popSize        
    ...
    if ADFFlag==0
    buffer = P0Samp_Final_var2(p0,p1,p11,p2,p22,p3,p33,p4,p44,BSPlusJ,ADFFlag,newnum,thresh);
    else
    r=rand;
      if r<=thresh
       buffer = P0Samp_Final_Ver2(p0,p1,p11,p2,p22,p3,p33,p4,p44,BSPlusJ,ADFFlag,newnum,thresh);
      else
        buffer = ADF_P0Samp_Final(newnum) ;
      end
    end
